        ...
        <>
            <Layout>
                <div className={styles.container}>
                    ...
                    <section>
                        {/*<h3 className={styles.title}>{accommodation &&accommodation.title}</h3>*/}
                        {/*<span className={styles.location}>{accommodation && accommodation.location}</span>*/}
                        ...
                        <div className={styles.rating}>
                            ...
                            <div className={styles.flex}>
                                <div className={styles.tutu}>
                                    {/*<span>{accommodation && accommodation.host.name}</span>*/}
                                </div>
                    ...
                    <section>
                        {/*<Collapse title={"Description"} text={accommodation && accommodation.description} />*/}
                    </section>
                    <section>
                        {/*<Collapse title={"Equipment"} list={accommodation && accommodation.equipments} />*/}
                    </section>
                </div>
            </Layout>
        </>
